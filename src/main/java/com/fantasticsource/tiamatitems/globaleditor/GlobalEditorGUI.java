...
import com.fantasticsource.tiamatitems.itemeditor.TagCategoryGUI;
...
public class GlobalEditorGUI extends GUIScreen
{
    ...
    public static void show()
    {
        ...
        GlobalEditorGUI gui = new GlobalEditorGUI();
        Minecraft.getMinecraft().displayGuiScreen(gui);


        GlobalEditorGUI.actionList = actionList;
