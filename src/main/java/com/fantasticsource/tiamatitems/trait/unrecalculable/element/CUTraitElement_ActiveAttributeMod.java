...
public class CUTraitElement_ActiveAttributeMod extends CUnrecalculableTraitElement
{
    ...
    public double applyToItem(ItemStack stack, double itemTypeAndLevelMultiplier)
    {
        ...
        double amount = minAmount + (maxAmount - minAmount) * percent;
    ...
    @Override
    public CUTraitElement_ActiveAttributeMod write(ByteBuf buf)
    {
    ...
    @Override
    public CUTraitElement_ActiveAttributeMod read(ByteBuf buf)
    {
    ...
    @Override
    public CUTraitElement_ActiveAttributeMod save(OutputStream stream)
    {
    ...
    @Override
    public CUTraitElement_ActiveAttributeMod load(InputStream stream)
    {
